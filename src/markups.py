...
def get_markup_orders():
    ...
    markup.add(types.InlineKeyboardButton(text="Ссылка на GoogleSheets", url="https://docs.google.com/spreadsheets/d/15tn2njoCZU7pnW9M3kU2KojHHYxo2BnZgw1WLHWkTvU/edit?usp=sharing"))
    return markup
